...
const val GROUP_1_SINGLE_TAX_MONTHLY_UAH = 332.80
const val GROUP_1_MILITARY_TAX_MONTHLY_UAH = 864.70
const val GROUP_2_ANNUAL_INCOME_LIMIT_UAH = 7_211_598
const val GROUP_2_SINGLE_TAX_MONTHLY_UAH = 1_729.40
const val GROUP_2_MILITARY_TAX_MONTHLY_UAH = 864.70
...
const val MONTHLY_ESV_UAH = 1_902.34
